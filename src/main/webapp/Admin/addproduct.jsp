...
.parent1 {
    ...
    height:100%;
    align-self: start;
    grid-template-rows: repeat(8, 0.62fr);
    padding-left:30px;
    padding-top:20px;
    padding-bottom:20px;
    grid-column-gap: 0px;
            ...
            <div class="parent1">
                ...
                <div class="div6 d ">
                   <label for="product_discount" class="labe">Discount  :</label>
                    <input id="product_discount" type="number" class="inp" name="dis_cost"  value=""   required>
                </div>
                <div class="div7 d">
                     <label for="product_specifications" class="labe">Availablity  :</label>
                ...
                <div class="div9 d" style="justify-content:center;padding-top:15px;">

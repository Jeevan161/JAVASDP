...
<body>
<section id="header" class="header" style="background:#91acbc">   
    <a href="/"><img src="../images/logo.png" style="padding-left:20px ;" class="logo" width="250px" height="60px" alt="Logo"></a>
     <div>
         <ul style="margin-top: 39px;" id="cs-navbar" class="cs-navbar">
             <li><a class="ah" href="/admin/home">Home</a></li>
             <li><a class="ah" href="/admin/sellers">View Sellers</a></li>
             <li><a  class="ah" href="/admin/verifyseller">Verify Sellers</a></li>

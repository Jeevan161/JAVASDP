...
<div class="main-con">
    ...
    <div class="mcleft" >
        ...
        <img src="/images/${product.img_url}" id="image-preview" style="margin-bottom:0px;"  class="def_profile">
    ...
    <div class="mcright">
            ...
            <div class="parent1">
                ...
                <div class="div1 d">
                    ...
                    <input id="product_name" type="text" name="name" value="${product.name}" class="inp" required>
                </div>
                <div class="div2 d">
                    <label for="category" class="labe">Type :</label>
                     <input id="product_name" type="text" name="type" value="${product.type}" class="inp" required>
                </div>
                        <div class="div3 d">
                ...
                <div class="div4 d">
                     ...
                     <textarea id="product_description" class="inp"  name="description" rows="3" required >${product.description}</textarea>
                </div>
				<div class="div5 d ">
                    <label for="product_price" class="labe">Quantity  :</label>
                    <input id="product_price" type="number" value="${product.quantity}" class="inp" name="quantity"  value=""   required>
                </div>
                <div class="div6 d ">
                    <label for="product_price" class="labe">Price  :</label>
                    <input id="product_price" type="number" value="${product.cost}" class="inp" name="cost"  value=""   required>
                </div>
                <div class="div7 d ">
                   <label for="product_discount" class="labe">Discount  :</label>
                    <input id="product_discount" type="number" value="${product.discount}" class="inp" name="dis_cost"  value=""   required>
                </div>
                <div class="div9 d">
                     <label for="availablity" class="labe">Availablity  :</label>
                     <label style="width:100px;">
					  <input type="radio" name="availablity" value="true">
					  Available
					</label>
					
					<label style="width:200px;">
					  <input type="radio" name="availablity" value="false">
					  Unavailable
					</label>
                </div>

    ...
    <a href="/"><img src="../images/logo.png" style="padding-left:20px ;" class="logo" width="250px" height="60px" alt="Logo"></a>
     <div>
         <ul style="margin-top: 39px;" id="cs-navbar" class="cs-navbar">
             <li><a class="active ah" href="/">Home</a></li>
             <li><a class="ah" href="/product">Shop</a></li>
             <li><a class="ah" href="#">Blog</a></li>
             <li><a class="ah" href="/about">About</a></li>
             <li><a  class="ah" href="/contactus">Contact</a></li>

    ...
    <section class="cart-container section-p1">
        ...
        <table class="product_table">
          <tr>
            ...
            <tr>
              <td style="padding:10px;border-radius: 10px 0 0 10px;padding:5px;text-align:center;">Watermelon</td>
        ...
        <input style="width:50px;" type="number" name="quantity" value="1" min="1" onchange="updatePrice(this, value)">
              ...
              <td style="padding:10px;border-radius:0 10px 10px  0;text-align:center;"><span class="product_price">18</span></td>
            </tr>
          ...
          <tr>
            ...
            <button  class="btn btn-primary" type="button" style="width:500px;padding:15px;background-color: #e0e4ff;color:#08817c;font-weight:600;font-size:15px;border-radius:20px;  onclick="CreateOrderID(1000, 125, '1000 INR - 125 Contacts')">Check Out</button>
